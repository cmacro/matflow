...
pub fn InboundPage() -> impl IntoView {
    ...
    let inbound_data = create_signal(vec![
        InboundItem {
            ...
            inbound_date: "2024-01-15".to_string(),
            quantity: 20,
            unit: "桶".to_string(),
        ...
        InboundItem {
            ...
            inbound_date: "2024-01-14".to_string(),
            quantity: 50,
            unit: "平方米".to_string(),
        ...
        InboundItem {
            ...
            inbound_date: "2024-01-16".to_string(),
            quantity: 100,
            unit: "平方米".to_string(),
    ...
    view! {
        <div class="bg-slate-900/30 backdrop-blur-md border border-slate-800 rounded-2xl p-6 shadow-xl">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-xl font-semibold text-slate-200">"入库流水"</h2>
                    <p class="text-sm text-slate-500">"Track material inbound records and warehouse intake"</p>
                </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-slate-800">
                            ...
                            <th class="text-right py-3 px-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">"Inbound Qty"</th>

...
pub fn OutboundPage() -> impl IntoView {
    ...
    let outbound_data = create_signal(vec![
        OutboundItem {
            id: 1,
                                ...
                                data.iter().map(|item| {
                                    view! {
                                        <tr class="hover:bg-slate-800/30 transition-colors">
                                            <td class="py-3 px-4 text-sm text-slate-300">{&item.outbound_date}</td>
                                            ...
                                            <td class="py-3 px-4 text-sm text-slate-300">{&item.purpose}</td>
